...
import { categoryCollections, CategoryObject } from "@/lib/data/shop-by-category"

export default function ShopByCategory() {
  return (
    <section className="py-12 bg-white dark:bg-black border-t-2 border-black dark:border-white">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl font-helvicta font-bold mb-8 text-center text-black dark:text-white">
          SHOP BY CATEGORY:
        </h2>

        {/* Desktop Grid */}
        <div className="hidden md:grid md:grid-cols-3 gap-8">
          {categoryCollections.map((category: CategoryObject) => (
